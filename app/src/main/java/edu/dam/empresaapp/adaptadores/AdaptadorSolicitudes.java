...
public class AdaptadorSolicitudes extends BaseAdapter{
    ...
    public AdaptadorSolicitudes(Context contexto, ArrayList<Trabajador> listItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = LayoutInflater.from(contexto).inflate(R.layout.item_adaptador_solicitudes, null);
